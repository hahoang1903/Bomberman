...
public class Sprite {
    ...
    public static int SCALED_SIZE = DEFAULT_SIZE * 2;
    ...
    public static Sprite tutorial_bomb = new Sprite(DEFAULT_SIZE, 3, 3, SpriteSheet.tiles, 16, 16);
    /*
    |--------------------------------------------------------------------------
    ...
    public static Sprite powerup_tutorial = new Sprite(DEFAULT_SIZE, 8, 10, SpriteSheet.tiles, 16, 16);
    public static Sprite heart = new Sprite(DEFAULT_SIZE, 9, 10, SpriteSheet.tiles, 16, 16);
    public static Sprite flames = new Sprite(DEFAULT_SIZE, 10, 10, SpriteSheet.tiles, 16, 16);
    ...
    public static void setScaledSize(int scale) {
        SCALED_SIZE = DEFAULT_SIZE * scale;
    }
